        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProblemType = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookProblems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookProblems_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookProblems_Members_MemberId",
                        column: x => x.MemberId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_BookQuotes_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_IssueRequests_Books_BookId",
                        column: x => x.BookId,
                        principalTable: "Books",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IssueRequests_Members_MemberId",
                        column: x => x.MemberId,
                        principalTable: "Members",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IssueRequestId = table.Column<int>(type: "int", nullable: false),
                    BookId = table.Column<int>(type: "int", nullable: false),
                    MemberId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_IssuedBooks_IssueRequests_IssueRequestId",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Indian writer known for Malgudi Days.", "R. K. Narayan" },
                    { 2, "Co-author of The Pragmatic Programmer.", "Andrew Hunt" },
                    { 3, "Co-author of The Pragmatic Programmer.", "David Thomas" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Novels and short stories", "Fiction" },
                    { 2, "Factual and reference works", "Non-Fiction" },
                    { 3, "STEM titles", "Science & Technology" },
                    { 4, "Historical accounts and biography", "History" },
                    { 5, "Books for young readers", "Children" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookProblems_BookId",
                table: "BookProblems",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_BookProblems_MemberId",
                table: "BookProblems",
                column: "MemberId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssuedBooks_IssueRequestId",
                table: "IssuedBooks",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_IssueRequests_BookId",
                table: "IssueRequests",
                column: "BookId");

            migrationBuilder.CreateIndex(
                name: "IX_IssueRequests_MemberId",
                table: "IssueRequests",
                column: "MemberId");
